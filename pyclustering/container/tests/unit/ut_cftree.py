...
from pyclustering.utils import euclidean_distance_sqrd, manhattan_distance, average_inter_cluster_distance, average_intra_cluster_distance, variance_increase_distance;
...
class CftreeUnitTest(unittest.TestCase):
    ...
    def templateDistanceCalculation(self, cluster1, cluster2, type_measurement):
        ...
        if (type_measurement == measurement_type.CENTROID_EUCLIDIAN_DISTANCE):
            assert distance12 == euclidean_distance_sqrd(entry1.get_centroid(), entry2.get_centroid());
