...
from pyclustering.utils import pi, calculate_ellipse_description, euclidean_distance_sqrd;
    ...
    def __calculate_initial_clusters(self, centers):
        ...
        for index_point in range(len(self.__sample)):
            ...
            for index in range(len(centers)):
                dist = euclidean_distance_sqrd(self.__sample[index_point], centers[index]);
